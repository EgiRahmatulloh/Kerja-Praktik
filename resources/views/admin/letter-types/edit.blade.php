        ...
        <div class="card-body">
            <form action="{{ route('admin.letter-types.update', $letterType->id) }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_jenis') is-invalid @enderror" id="nama_jenis" name="nama_jenis" value="{{ old('nama_jenis', $letterType->nama_jenis) }}" required>
                            @error('nama_jenis')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kode_surat') is-invalid @enderror" id="kode_surat" name="kode_surat" value="{{ old('kode_surat', $letterType->kode_surat) }}" required maxlength="10" placeholder="Contoh: DOM, USH">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" rows="3">{{ old('deskripsi', $letterType->deskripsi) }}</textarea>
                    @error('deskripsi')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group mb-3">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="is_public" name="is_public" value="1" {{ old('is_public', $letterType->is_public) ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="data_item_{{ $item->id }}" name="data_items[]" value="{{ $item->id }}"
                                        {{ (old('data_items') && in_array($item->id, old('data_items'))) || 
                                       (old('data_items') === null && $letterType->dataItems->contains($item->id)) ? 'checked' : '' }}>
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('admin.letter-types.show', $letterType->id) }}" class="btn btn-outline-secondary">
