...
@section('title', 'Edit Variabel Surat')

@section('content')
<div class="container-fluid">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Edit Variabel Surat</h5>
            <a href="{{ route('admin.data-items.index') }}" class="btn btn-secondary">
                <i class="bi bi-arrow-left"></i> Kembali
            </a>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.data-items.update', $dataItem->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('key') is-invalid @enderror" id="key" name="key" value="{{ old('key', $dataItem->key) }}" required>
                            @error('key')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('label') is-invalid @enderror" id="label" name="label" value="{{ old('label', $dataItem->label) }}" required>
                            @error('label')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" id="required" name="required" value="1" {{ old('required', $dataItem->required) ? 'checked' : '' }}>
                ...
                <div class="form-group mb-3" id="options-container" style="{{ old('tipe_input', $dataItem->tipe_input) == 'select' ? '' : 'display: none;' }}">
                    <label for="options" class="form-label">Opsi Pilihan <span class="text-danger">*</span></label>
                    <textarea class="form-control @error('opsi') is-invalid @enderror" id="options" name="opsi" rows="3">{{ old('opsi', $dataItem->opsi) }}</textarea>
                    @error('opsi')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control @error('help_text') is-invalid @enderror" id="help_text" name="help_text" value="{{ old('help_text', $dataItem->help_text) }}">
                    @error('help_text')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const inputType = document.getElementById('tipe_input');
