                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kode_surat') is-invalid @enderror" id="kode_surat" name="kode_surat" value="{{ old('kode_surat', $template->kode_surat) }}" required maxlength="10" placeholder="Contoh: DOM, USH">
