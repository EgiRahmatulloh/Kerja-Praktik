        ...
        <div class="sidebar pe-4 pb-3" style="overflow-y: auto; max-height: 100vh;">
            <nav class="navbar bg-light navbar-light">
                <a href="{{ route('user.dashboard') }}" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary">Sistem Surat</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('user.letters.index') }}" class="nav-item nav-link {{ request()->routeIs('user.letters.index') ? 'active' : '' }}">
                        <i class="fa fa-file-alt me-2"></i>Ajukan Surat
                    </a>
                    <a href="{{ route('user.letters.history') }}" class="nav-item nav-link {{ request()->routeIs('user.letters.history') ? 'active' : '' }}">
                        <i class="fa fa-history me-2"></i>Riwayat Surat
                    </a>
                    <a href="{{ route('user.letter-queues.index') }}" class="nav-item nav-link {{ request()->routeIs('user.letter-queues.*') ? 'active' : '' }}">
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">Sistem Surat Desa</a>, All Right Reserved.
                        </div>
